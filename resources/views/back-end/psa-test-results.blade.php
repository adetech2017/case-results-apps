...
@section('content')
<!-- Page Heading -->
<h1 class="mb-2 text-gray-800 h3">PSA - Prostate specific antigen</h1>

<!-- DataTales Example -->
<div class="mb-4 shadow card">
    <div class="py-3 card-header">
        <h6 class="m-0 font-weight-bold text-primary">All PSA Test</h6>
    </div>
    @php
        $now = new DateTime();
                ...
                <tbody>
                    ...
                    @foreach($data as $value)
                        <tr>
                            ...
                            @endphp
                            <td>
                                <a class="btn btn-primary" href="{{ url('print-psa-result')}}/{{ $value->id }}" title="View">
