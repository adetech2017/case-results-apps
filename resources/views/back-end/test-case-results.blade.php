...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">PCR Test Results</h1>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">All PCR Results</h6>
    </div>
    @php
        $now = new DateTime();
                ...
                <tbody>
                    ...
                    @foreach($data as $value)
                        <tr>
                            ...
                            <td>{{ Crypt::decryptString($value->sample_collection_date) }}-{{ Crypt::decryptString($value->sample_collection_time) }}</td>
                            @php
